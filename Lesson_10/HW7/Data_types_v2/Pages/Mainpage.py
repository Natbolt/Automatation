...
from HW7.constants import Test_form_URL
from HW7.Data_types_v2.data import *
import allure
...
class MainPage:
    ...
    @allure.step("Открываем сраницу заполения формы")
    def open(self):
        self.browser.get(Test_form_URL)

    @allure.step("Находим необходимые поля для заполнения на главной странице")
